 ...
 *
 * @author ODB Team - Mohammad Anzawi
 * @author_uri https://ODB.org
...
use \ODB\DB\Collection\Collection;
...
{
	use \ODB\DB\Variables;
	use \ODB\DB\Providers\Provider;
	use \ODB\DB\DDL\Base;
	use \ODB\DB\DML\Main;
	use \ODB\DB\Relation\Main;
	use \ODB\DB\Operations\Main;
